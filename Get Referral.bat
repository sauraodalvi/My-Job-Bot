...
REM 1) If the private venv already exists, just use it directly. This keeps the
REM    launcher working even when no system Python (py/python) is on PATH.
if exist "%VENV_PY%" goto :have_venv

REM 2) No venv yet - find any installed Python to create it.
set "PYLAUNCH="
